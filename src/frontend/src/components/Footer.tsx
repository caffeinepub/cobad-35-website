    ...
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center">
          <p className="text-primary-foreground/80 flex items-center justify-center gap-2 flex-wrap">
            © {currentYear} COBAD 35. Todos los derechos reservados.
          </p>
          <p className="text-primary-foreground/60 mt-2 flex items-center justify-center gap-2">
