    ...
    <footer className="bg-burgundy text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">COBAT 35</h3>
        ...
        <div className="border-t border-white/20 pt-8 text-center">
          <p className="text-white/80 flex items-center justify-center gap-2 flex-wrap">
            © {currentYear} COBAT 35. Todos los derechos reservados.
          </p>
          <p className="text-white/70 mt-2">
            Página creada por Omar García Arias, alumno del COBAT 35
          </p>
