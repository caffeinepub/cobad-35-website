...
export class Backend implements backendInterface {
    ...
    async getApplications(): Promise<Array<EnrollmentApplication>> {
    ...
    async getQuestions(): Promise<Array<StudentQuestion>> {
        if (this.processError) {
            try {
    ...
    async submitApplication(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitQuestion(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitQuestion(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
